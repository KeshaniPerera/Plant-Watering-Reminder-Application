...
import { SignupvalidationSchema } from '../formValidation.jsx';
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    <div className="flex space-x-4">
                        <div className="flex-1">
                            <label htmlFor="firstName" className="block text-xs font-medium pb-2 text-gray-600">
                                First Name
                            </label>
                            <input
                                type="text"
                            ...
                            />
                            {errors.firstName && (
                                <p className="text-red-500 text-xs p-2">{errors.firstName}</p>
                            )}
                        </div>
                        <div className="flex-1">
                            <label htmlFor="lastName" className="block text-xs font-medium pb-2 text-gray-600">
                                Last Name
                            </label>
                            <input
                                type="text"
                            ...
                            />
                            {errors.lastName && (
                                <p className="text-red-500 text-xs p-2">{errors.lastName}</p>
                            )}
                        </div>
                    </div>

                    <div>
                        <label htmlFor="email" className="block text-xs font-medium pb-2 text-gray-600">
                            Email
                        </label>
                        <input
                            type="text"
                        ...
                        />
                        {errors.email && (
                            <p className="text-red-500 text-xs p-2">{errors.email}</p>
                        )}
                    </div>

                    <div>
                        <label htmlFor="password" className="block text-xs font-medium pb-2 text-gray-600">
                            Password
                        </label>
                        <input
                            type="password"
                        ...
                        />
                        {errors.password && (
                            <p className="text-red-500 text-xs p-2">{errors.password}</p>
                        )}
                    </div>

                    <div>
                        <label htmlFor="retypePassword" className="block text-xs font-medium pb-2 text-gray-600">
                            Confirm Password
                        </label>
                        <input
                            type="password"
                        ...
                        {errors.retypePassword && (
                            <p className="text-red-500 text-xs p-2">{errors.retypePassword}</p>
                        )}
                    </div>
